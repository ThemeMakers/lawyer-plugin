...
class CSFramework extends CSFramework_Abstract
{
   ...
   *
   */
  public string $unique = CS_OPTION;
  ...
  // instance
  public static function instance(array $settings = [], array $options = []): ?self
  {
    if (self::$instance === null && CS_ACTIVE_FRAMEWORK) {
  ...
  // wp settings api
  public function settings_api(): void
  {
    $defaults = [];
  ...
  public function validate_save(array $request): ?array
  {
          ...
          if (isset($field['type']) && ! isset($field['multilang']) && isset($field['id'])) {
            ...
            if (isset($field['validate']) && has_filter('cs_validate_' . $field['validate'])) {
              ...
              if (! empty($validate)) {
                ...
                $request[$field['id']] = $this->get_option[$field['id']] ?? '';
              }
            }
          }
  ...
  public function field_callback(array $field): void
  {
  ...
  // settings sections
  public function do_settings_sections(string $page): void
  {
  ...
  // settings fields
  public function do_settings_fields(string $page, string $section): void
  {
  ...
  public function add_settings_error(string $message, string $type = 'error', string $id = 'global'): array
  {
